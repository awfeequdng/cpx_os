#ifndef __KERNEL_DRIVER_KBDREG_H__
#define __KERNEL_DRIVER_KBDREG_H__

#ifndef CPX_OS_KERNEL
# error "this is a kernel header file, only #include by kernel source"
#endif
...
#endif /* !__KERNEL_DRIVER_KBDREG_H__ */
